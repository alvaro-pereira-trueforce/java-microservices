...
<body>
    <div class="card center" style="max-width: 800px">
        <div class="card-body">
            ...
            <p>Hi, {{$name}}.We need to you provide us the telegram token that was generated with Telegram Bot Father in order to start working with telegram channel service.</p>
            ...
            <form method="post" action="./admin_ui_2">
                ...
                <input type="hidden"
                       name="return_url" value="{{$subdomain}}">
