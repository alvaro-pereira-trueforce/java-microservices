...
use APIServices\Zendesk_Linkedin\Helpers\LinkedInStatisticsArrays;
use Illuminate\Support\Collection;
use Illuminate\Support\Facades\App;

/**
 * Class BaseObject
 * @package APIServices\Zendesk_Linkedin\Helpers\Objects
 */
abstract class BaseObject extends Collection
{
    ...
    /**
     * @return LinkedInStatisticsArrays
     */
    public function getHelperArray()
    {
        /** @var LinkedInStatisticsArrays $response */
        $response = App::make(LinkedInStatisticsArrays::class);
        return $response;
    }
}